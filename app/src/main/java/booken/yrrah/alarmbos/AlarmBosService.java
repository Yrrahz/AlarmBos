...
public class AlarmBosService extends IntentService {
    ...
    private static final String EXTRA_PARAM1 = "booken.yrrah.alarmbos.extra.PARAM1";
    private static final String EXTRA_PARAM2 = "booken.yrrah.alarmbos.extra.PARAM2";

    public AlarmBosService() {
        super("AlarmBosService");
    }
